...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'marketing-manager', 'social-media-specialist', 'content-creator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Campaign', path: '/campaigns', entity: 'campaign', service: AccessServiceEnum.PROJECT, icon: FiFlag },
    {
      ...
      path: '/campaign-platforms',
      entity: 'campaign_platform',
      service: AccessServiceEnum.PROJECT,
      icon: FiBox,
    },
    { name: 'Content', path: '/contents', entity: 'content', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Platform', path: '/platforms', entity: 'platform', service: AccessServiceEnum.PROJECT, icon: FiMonitor },
