...
import { getCampaignPlatformById } from 'apiSdk/campaign-platforms';
...
function CampaignPlatformViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Campaign Platform Detail View
          </Text>
          {hasAccess('campaign_platform', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/campaign-platforms/edit/${data?.id}`} passHref legacyBehavior>
              <Button
